...
namespace NESEmulatorTests.CPU6502.InstructionSet.Operations
{
    ...
    public class AddWithCarryTest
    {
        ...
        public void TestADCImmediate()
        {
            ...
            registers.SetRegister(Register.A, 0b01010001);
            ...
            Assert.AreEqual(registers.GetRegister(Register.A), 0b01111111);
        ...
        public void TestADCImmediateWithOverflow()
        {
            ...
            registers.SetRegister(Register.A, 0b10000010);
            ...
            Assert.AreEqual(registers.GetRegister(Register.A), 0b01000100);
        ...
        public void TestADCWithAddress()
        {
            ...
            registers.SetFlag(StatusRegisterFlags.Carry, false);
            registers.SetRegister(Register.A, 0b11111111);
