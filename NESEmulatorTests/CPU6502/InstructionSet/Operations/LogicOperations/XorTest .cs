...
namespace NESEmulatorTests.CPU6502.InstructionSet.Operations
{
    ...
    public class XorTest
    {
        ...
        public void TestXorImmediate()
        {
            ...
            registers.SetRegister(Register.Accumulator, 0b00011100);
            ...
            Assert.AreEqual(registers.GetRegister(Register.Accumulator), 0b01001001);
        ...
        public void TestXorWithAddress()
        {
            ...
            registers.SetRegister(Register.Accumulator, 0b10101010);
