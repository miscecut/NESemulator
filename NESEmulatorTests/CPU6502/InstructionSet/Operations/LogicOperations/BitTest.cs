...
namespace NESEmulatorTests.CPU6502.InstructionSet.Operations
{
    ...
    public class BitTest
    {
        ...
        public void TestBitImmediate()
        {
            ...
            registers.SetRegister(Register.Accumulator, 0b01011100);
            ...
            Assert.AreEqual(registers.GetRegister(Register.Accumulator), 0b01011100); //the accumulator did not change
        ...
        public void TestBitWithAddress()
        {
            ...
            registers.SetRegister(Register.Accumulator, 0b10000000);
            ...
            Assert.AreEqual(registers.GetRegister(Register.Accumulator), 0b10000000);
            Assert.IsFalse(registers.GetFlag(StatusRegisterFlags.Zero));
