...
namespace NESEmulatorTests.CPU6502.InstructionSet.AddressingModes
{
    ...
    public class AddressingModesTest
    {
        ...
        public void TestAbsolute()
        {
            ...
            _registers.ProgramCounter = 0x1122;
            ...
            Assert.AreEqual(_registers.ProgramCounter, 0x1124); //2 ticks of program counter (for the address parts) are requested
        }
        ...
        public void TestZeroPage()
        {
            ...
            Assert.AreEqual(_registers.ProgramCounter, 0x1123); //1 tick of program counter (for the lo address part) is requested
        }
        ...
        public void TestAbsoluteXIndexed()
        {
            ...
            _registers.ProgramCounter = 0x0A32;
            _registers.X = 0x03;
            ...
            Assert.AreEqual(_registers.ProgramCounter, 0x0A34);
        }
        ...
        public void TestZeroPageXIndexed()
        {
            ...
            _registers.ProgramCounter = 0x1256;
            _registers.X = 0x08;
            ...
            Assert.AreEqual(_registers.ProgramCounter, 0x1257);
        }
        ...
        public void TestZeroPageYIndexed()
        {
            ...
            _registers.ProgramCounter = 0xF555;
            _registers.Y = 0xA0;
            ...
            Assert.AreEqual(_registers.ProgramCounter, 0xF556);
        }
        ...
        public void TestAbsoluteIndirect()
        {
            ...
            _registers.ProgramCounter = 0x58A4;
            ...
            Assert.AreEqual(_registers.ProgramCounter, 0x58A6); //2 ticks of program counter (for the address parts) are requested
        }
        ...
        public void TestIndexedXIndirect()
        {
            ...
            _registers.ProgramCounter = 0x0200;
            _registers.X = 0x0003;
            ...
            Assert.AreEqual(_registers.ProgramCounter, 0x0201);
        }
        ...
        public void TestIndirectYIndexedWithPageJump()
        {
            ...
            var absoluteIndirect = new IndirectYIndexed();
            _registers.ProgramCounter = 0x4441;
            _registers.Y = 0x0001;
            ...
            Assert.AreEqual(_registers.ProgramCounter, 0x4442);
        }
